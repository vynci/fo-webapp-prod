...
var ReportsComponent = (function () {
    function ReportsComponent(modalService, _sensorLogService, _widgetService) {
...
ReportsComponent = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        ...
        providers: [__WEBPACK_IMPORTED_MODULE_3__services_sensorLog_service__["a" /* SensorLogService */], __WEBPACK_IMPORTED_MODULE_4__services_widget_service__["a" /* WidgetService */]]
    }),
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_2__ng_bootstrap_ng_bootstrap__["c" /* NgbModal */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__ng_bootstrap_ng_bootstrap__["c" /* NgbModal */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_3__services_sensorLog_service__["a" /* SensorLogService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__services_sensorLog_service__["a" /* SensorLogService */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_4__services_widget_service__["a" /* WidgetService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4__services_widget_service__["a" /* WidgetService */]) === "function" && _c || Object])
], ReportsComponent);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__reports_routing_module__ = __webpack_require__("../../../../../src/app/layout/reports/reports-routing.module.ts");
...
var SensorLogService = (function () {
    function SensorLogService(http) {
        ...
        this.endpoint = 'http://192.168.43.226:3000/v1/api/';
        this.url = this.endpoint + 'sensor-log';
        this.options = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["d" /* RequestOptions */]({ headers: this.headers });
    }
    SensorLogService.prototype.getAll = function (data, skip, limit) {
...
var WidgetService = (function () {
    function WidgetService(http) {
        this.http = http;
        this.headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["c" /* Headers */]({ 'Content-Type': 'application/json' });
        this.endpoint = 'http://localhost:3000/v1/api/';
        this.url = this.endpoint + 'widget';
        this.options = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["d" /* RequestOptions */]({ headers: this.headers });
    }
    ...
    WidgetService.prototype.create = function (data) {
        var body = data;
        return this.http.post(this.url, JSON.stringify(body), { headers: this.headers })
            .map(function (response) { return response.json(); });
    };
    WidgetService.prototype.update = function (data) {
        var body = data;
        var url = this.url + '/' + body._id;
        return this.http.put(url, JSON.stringify(body), { headers: this.headers })
            .map(function (response) { return response.json(); });
